...
public class CommentReportController {
	...
	public ResponseEntity<?> saveComment(@RequestBody CommentDynamicDTO commentDynamicDTO) {
		...
		commentDynamicDTO.setBoardNo(commentDynamicDTO.getReportNo());
	...
	@GetMapping
	public ResponseEntity<?> findAllComment(@RequestParam(name = "reportNo") Long reportNo) {
		List<CommentDTO> list = commentDynamicService.findAllComment(reportNo, COMMENT_TYPE);
